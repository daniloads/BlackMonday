...
public class ValidadorPedido {
    ...
    public void validarPedido(HttpServletRequest request) {
        ...
        if (naumTemTamanhoMinimo(request, "telefone", 10) || temDigitosNaumNumericos(request, "telefone")) {
            listaDeProblemas.add("Numero de telefone invalido (10 digitos ex: prefixo 2 digitos + No.Fone 8 digitos)");
        }
        
        if (temDigitosNaumNumericos(request, "numero")) {
            listaDeProblemas.add("Numero deve ser numerico");
        }
