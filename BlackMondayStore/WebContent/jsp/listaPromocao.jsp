...
<title>BlackMondayStore - Promoções</title>
...
<body>
	...
	<p class="barNav">
		<a href="listaProdutos.jsp">Lista todos os Produtos</a> 
		<a href="menuUsuario.jsp">Area Restrita</a>
	</p>
	<h1>
		<i><small>Promoção é aqui na BlackMondayStore</small></i>
	</h1>
	<jsp:useBean id="ProdutosPromocao"
		class="br.com.fiap.control.dao.ProdutoDAO"></jsp:useBean>
	...
	<table border='1'>
		...
		<c:forEach var="produto" items="${ProdutosPromocao.promocaoProdutos}">
			<tr style="width: =">
				<td class='gridCampo'><img src='../imagens/${produto.imagem}' /></td>
				<td><a href='/detalheProduto?id=${produto.id}'>${produto.codigo}</a>
